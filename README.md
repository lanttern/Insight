...
Additionally, feature engineering techniques using [differnt ngrams (2-5 ngrams)](https://github.com/lanttern/Insight/blob/master/MedicalRecordsStrokePrediction-ngram.ipynb) or using [word2vector](https://github.com/lanttern/Insight/blob/master/MedicalRecordsStrokePrediction-Word2Vector.ipynb) are compared.
